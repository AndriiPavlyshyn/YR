...
gulp.task('css-redirect', function() {
	return gulp.src(['app/css/uikit-rtl.min.css', 'app/css/slick-theme.css', 'app/css/slick.css', 'app/css/includes.css'])
...
gulp.task('watch', ['browser-sync', 'sass', 'fonts-redirect', 'css-redirect', 'fileinclude', 'js-concat', 'img-redirect'], function() {
		...
		gulp.watch('app/js/**/*.js', ['js-concat']);   // Наблюдение за JS файлами в папке js
});
